...
_PATTERN = re.compile(r"invoice\s*number[:\s]*([A-Z0-9][A-Z0-9\-]*\d[A-Z0-9\-]*)", re.IGNORECASE)
_NUMBER_PREFIX_PATTERN = re.compile(r"^number\s*", re.IGNORECASE)
_DIGIT_PATTERN = re.compile(r"\d")


class InvoiceNumberColonExtractor(IInvoiceNumberExtractor):
    @property
    def Name(self) -> str:
    ...
    def ExtractAll(self, context):
        ...
        for match in matches:
            ...
            num = _NUMBER_PREFIX_PATTERN.sub("", num)
