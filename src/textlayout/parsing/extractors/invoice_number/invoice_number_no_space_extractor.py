...
_PATTERN = re.compile(r"invoice\s*number([A-Z]{2,}[A-Z0-9\-]*\d+)", re.IGNORECASE)
_DIGIT_PATTERN = re.compile(r"\d")


class InvoiceNumberNoSpaceExtractor(IInvoiceNumberExtractor):
    @property
    def Name(self) -> str:
        return "Invoice Number (no separator)"
